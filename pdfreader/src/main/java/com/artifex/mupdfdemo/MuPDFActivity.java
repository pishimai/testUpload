...
//						InputStream is = getContentResolver().openInputStream(uri);
						...
						int len = is.available();//获取文件大小
						byte[] c = new byte[len];
						is.read(c);
						buffer = cipher.doFinal(c);
...
//		mLinkButton.setColorFilter(highlight ? Color.argb(0xFF, 172, 114, 37) : Color.argb(0xFF, 255, 255, 255));
	...
	private void showButtons() {
		...
		if (!mButtonsVisible) {
			...
			anim = new TranslateAnimation(0, 0, rlSlider.getHeight(), 0);
			anim.setDuration(200);
			anim.setAnimationListener(new Animation.AnimationListener() {
				public void onAnimationStart(Animation animation) {
	...
	private void hideButtons() {
		if (mButtonsVisible) {
			...
			anim = new TranslateAnimation(0, 0, 0, rlSlider.getHeight());
			anim.setDuration(200);
			anim.setAnimationListener(new Animation.AnimationListener() {
				public void onAnimationStart(Animation animation) {
				...
				public void onAnimationRepeat(Animation animation) {}
				public void onAnimationEnd(Animation animation) {
					rlSlider.setVisibility(View.INVISIBLE);
				}
			});
			rlSlider.startAnimation(anim);
		}
	...
	private void makeButtonsView() {
		...
		rlSlider = (RelativeLayout) mButtonsView.findViewById(R.id.rlSlider);
		rlSlider.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
			}
		});
		backButton = (ImageButton) mButtonsView.findViewById(R.id.backButton);
